...
import 'package:medicine_app/UI/widgets/input_field.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                InputField(title: "Medicine name", hint: "Enter your Medicine name", controller: _titleController ,),
                ...
                Row(
                  ...
                  children: [
                    _colorPallete(),
                    TheButton(label: "Add Medicine", onTap: () => _validateDate())
                  ],
                )
              ],
            ),
...
_addTaskToDb() async {
  ...
  print("Database saved Task counter : "+"$value");
              ...
              3,
                ...
                return GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: CircleAvatar(
                      radius: 14,
                      backgroundColor: index==0?primarycolor:index==1?pink:yellow,
...
setState(() {
  ...
  print(_selectedDate);
      ...
      print("It's null or something is worng");
